...
# 加载 config
config_file = 'configs/mask_rcnn_r50_fpn_1x_coco2.py'
checkpoint_file = 'work_dirs/mask_rcnn_r50_fpn_1x_coco2/epoch_100.pth'
img_file = 'demo/in/2009_000759.jpg'
...
imshow_det_bboxes(
 ...
 scores[:10],
 show=False,
 out_file='outputs/inproposal/2009_000759.jpg'
)
# mmcv.imwrite(img_model, 'outputs/inproposal/2007_000822.jpg')
#2008_000009.jpg 2009_000628.jpg 2009_000759.jpg
