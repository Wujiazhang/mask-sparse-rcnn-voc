...
class PASCALVOC2COCO(object):
    ...
    def convert(self, devkit_path, year, split, save_file):
        ...
        name_list = list_from_file(split_file)
        images, annotations = [], []
        ann_id = 1
...
if __name__ == '__main__':
    ...
    year = '2012'
    split = 'train'
    save_file = './data/COCO/annotations/train.json'
    split1 = 'val'
    save_file1 = './data/COCO/annotations/val.json'
    converter.convert(devkit_path, year, split, save_file)
    converter.convert(devkit_path, year, split1, save_file1)